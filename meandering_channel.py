...
# xmin, xmax, dx = 0, 128, 16  # xmin: minimum x-coordinate (m); xmax: maximum x-coordinate (m); dx: cell length (m).
# ymin, ymax, dy = 0, 128, 16  # ymin: minimum y-coordinate (m); ymax: maximum y-coordinate (m); dy: cell width (m).
# zmin, zmax, dz = 0, 64, 8  # zmin: minimum z-coordinate (m); zmax: maximum z-coordinate (m); dz: cell height (m).
